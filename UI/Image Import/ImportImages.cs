...
public partial class ImportImages : Control
{
	...
	{
		// ritual = (Ritual) GetTree().CurrentScene.GetNode<Camera2D>("Camera2D").GetNode<SubViewportContainer>("SubViewportContainer").GetNode<SubViewport>("SubViewport").GetNode<Node2D>("Ritual");
		// ritual = (Ritual) GetTree().CurrentScene.GetNode<SubViewportContainer>("SubViewportContainer").GetNode<SubViewport>("SubViewport").GetNode<Node2D>("Ritual");
